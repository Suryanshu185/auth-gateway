...
var filter_TenantUser_ListTenantOrgUnitsWithRoles_0 = &utilities.DoubleArray{Encoding: map[string]int{"tenant": 0, "username": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}

func request_TenantUser_ListTenantOrgUnitsWithRoles_0(ctx context.Context, marshaler runtime.Marshaler, client TenantUserClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq TenantOrgUnitsWithRolesListReq
		metadata runtime.ServerMetadata
		err      error
	)
	io.Copy(io.Discard, req.Body)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_TenantUser_ListTenantOrgUnitsWithRoles_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.ListTenantOrgUnitsWithRoles(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_TenantUser_ListTenantOrgUnitsWithRoles_0(ctx context.Context, marshaler runtime.Marshaler, server TenantUserServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq TenantOrgUnitsWithRolesListReq
		metadata runtime.ServerMetadata
		err      error
	...
	msg, err := server.ListTenantOrgUnitsWithRoles(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterTenantUserHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TenantUserServer) error {
	...
	mux.Handle(http.MethodGet, pattern_TenantUser_ListTenantOrgUnitsWithRoles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/api.TenantUser/ListTenantOrgUnitsWithRoles", runtime.WithHTTPPathPattern("/api/auth/v1/tenant/{tenant}/user/{username}/ous"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_TenantUser_ListTenantOrgUnitsWithRoles_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_TenantUser_ListTenantOrgUnitsWithRoles_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterTenantUserHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TenantUserClient) error {
	...
	mux.Handle(http.MethodGet, pattern_TenantUser_ListTenantOrgUnitsWithRoles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/api.TenantUser/ListTenantOrgUnitsWithRoles", runtime.WithHTTPPathPattern("/api/auth/v1/tenant/{tenant}/user/{username}/ous"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_TenantUser_ListTenantOrgUnitsWithRoles_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_TenantUser_ListTenantOrgUnitsWithRoles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"api", "auth", "v1", "tenant", "user", "username", "ous"}, ""))
)
...
var (
	...
	forward_TenantUser_ListTenantOrgUnitsWithRoles_0 = runtime.ForwardResponseMessage
)
